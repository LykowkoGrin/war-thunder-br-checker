...
class WikiParser:
    ...
    __UTF8_logos = {
        ...
        # https://wiki.warthunder.ru/unit/sea_hawk_fga50_netherlands
        '◘': '[france2]',
        ...
        # https://wiki.warthunder.com/unit/a_4e_early_iaf
        "\uf059": '[israel]',
        '◡': '[israel2]',  # https://wiki.warthunder.com/unit/kfir_c10_colombia
        # https://wiki.warthunder.com/unit/f-86f-30_japan?ysclid=m5b3n4hswz675567527
        '▅': '[japan]',
        # https://wiki.warthunder.com/unit/bf-109f-4_hungary?ysclid=m5azy7g06f628044059
        '◐': '[italy]',
        '◔': '[italy2]',  # https://wiki.warthunder.com/unit/yak-9p_hungary
        # https://wiki.warthunder.com/unit/tempest_mkv_luftwaffe
        '▀': '[germany]',
    ...
    def __handle_page_source(self) -> dict:
        ...
        standart_units = soup.find_all(
            'tr', class_='wt-ulist_unit wt-ulist_unit--regular')
        premium_units = soup.find_all(
            'tr', class_='wt-ulist_unit wt-ulist_unit--prem')
        units_element = standart_units + premium_units
        for unit in standart_units:
            name = unicodedata.normalize("NFKD", unit.find(
                'td', class_='wt-ulist_unit-name').text)
...
def main():
    ...
    """)
    base_path = os.getcwd()
    # input("Enter path to msedgedriver.exe: ")#"C:/Users/lykow/Desktop/edgedriver_win64/msedgedriver.exe"
    driver_path = "C:/Users/lykow/Desktop/edgedriver_win64/msedgedriver.exe"
